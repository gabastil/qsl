...
<div
  style="--media-viewer-scale: {state.zoom};
        --media-viewer-rotate: {state.rotate};
        --media-viewer-x: {100 * state.x}%;
        --media-viewer-y: {100 * state.y}%;
        --media-viewer-minimap-scale: {state.minimap.scale};
        --media-viewer-minimap-width: {state.minimap.width};
        --media-viewer-minimap-height: {state.minimap.height};
        ...
        --media-viewer-minimap-limit-height: {Math.min(
            1 - state.y,
